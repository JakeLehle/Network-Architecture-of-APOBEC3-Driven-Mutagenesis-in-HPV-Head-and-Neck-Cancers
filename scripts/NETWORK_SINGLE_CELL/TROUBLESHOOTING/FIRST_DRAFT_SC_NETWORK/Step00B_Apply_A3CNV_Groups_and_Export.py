...
def step6_export(adata_basal, high_cells, cnv_cells, normal_cells):
    ...
    networks = {
        'NETWORK_A': ('SBS2-HIGH vs CNV-HIGH', high_cells, cnv_cells),
        'NETWORK_B': ('SBS2-HIGH vs NORMAL', high_cells, normal_cells),
        'NETWORK_C': ('CNV-HIGH vs NORMAL', cnv_cells, normal_cells),
    }
...
def main():
    ...
    log(f"    Network A (HIGH vs CNV):    Steps 01-04 with NETWORK_A/ inputs")
    log(f"    Network B (HIGH vs NORMAL): Steps 01-04 with NETWORK_B/ inputs")
    log(f"    Network C (CNV vs NORMAL):  Steps 01-04 with NETWORK_C/ inputs")
