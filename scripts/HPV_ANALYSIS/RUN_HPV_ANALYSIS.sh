#!/bin/bash
#SBATCH --job-name=FIG6_HPV
#SBATCH --output=/master/jlehle/WORKING/LOGS/FIG6_HPV_%j.out
#SBATCH --error=/master/jlehle/WORKING/LOGS/FIG6_HPV_%j.err
...
echo "=============================================="
echo "Figure 6 Phase 1: HPV16 Data Inventory"
